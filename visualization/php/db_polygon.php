<?php
	...
	$query = "SELECT osm_id, name, amenity, ST_AsGeoJSON(ST_Transform(ST_Simplify(way,1),4326)) as geometry  FROM planet_osm_polygon  WHERE way is not null and amenity='parking';";
